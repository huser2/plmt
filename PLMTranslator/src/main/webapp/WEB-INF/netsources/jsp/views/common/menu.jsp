...
<div id="menu">
	<ul id="navigation">
		...
		<li><spring:url value="/config" var="configUrl" htmlEscape="true" />
			<a href="${configUrl}">Config</a>
			<ul>
				<li><spring:url value="/config/queues" var="queuesUrl"
						htmlEscape="true" /> <a href="${queuesUrl}">Queues</a></li>

				<li><spring:url value="/config/messages" var="messagesUrl"
						htmlEscape="true" /> <a href="${messagesUrl}">Messages</a></li>
