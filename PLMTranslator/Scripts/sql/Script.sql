...
ALTER TABLE "PLMT"."PLMATTRIBUTELIST" DROP CONSTRAINT "SQL150103133239000";

ALTER TABLE "PLMT"."PLMATTRIBUTEMAPPING" DROP CONSTRAINT "PLMATTRIBUTEMAPPING_PK";

ALTER TABLE "PLMT"."PLMTYPELIST" DROP CONSTRAINT "SQL150105132312350";

ALTER TABLE "PLMT"."COMPLETEDJOBS" DROP CONSTRAINT "SQL141223214738620";

ALTER TABLE "PLMT"."QUEUE" DROP CONSTRAINT "SQL141223214738390";

ALTER TABLE "PLMT"."PLM_MAPPING" DROP CONSTRAINT "PLM_MAPPING_PK";

ALTER TABLE "PLMT"."FAILEDJOBS" DROP CONSTRAINT "SQL141223214738910";

DROP INDEX "PLMT"."FAILEDJOBS_CIDX";

DROP INDEX "PLMT"."SQL141230115745090";
...
DROP INDEX "PLMT"."SQL141223214738910";

DROP INDEX "PLMT"."SQL150105132312350";

DROP INDEX "PLMT"."QUEUE_MIDSEQX";

DROP INDEX "PLMT"."SQL150103133239000";

DROP INDEX "PLMT"."QUEUE_EIDX";

DROP INDEX "PLMT"."FAILEDJOBS_PIDX";

DROP INDEX "PLMT"."SQL141223214738390";

DROP INDEX "PLMT"."QUEUE_PIDX";

DROP INDEX "PLMT"."QUEUE_CIDX";

DROP INDEX "PLMT"."SQL150106115450110";
...
DROP INDEX "PLMT"."SQL141223214738620";

DROP INDEX "PLMT"."SQL141223214747930";

DROP INDEX "PLMT"."FAILEDJOBS_EIDX";

DROP INDEX "PLMT"."COMPLETEDJOBS_XIDX";

DROP INDEX "PLMT"."SQL141223214747780";

DROP TABLE "PLMT"."FAILEDJOBS";

DROP TABLE "PLMT"."PLMTYPELIST";

DROP TABLE "PLMT"."COMPLETEDJOBS";

DROP TABLE "PLMT"."PLMATTRIBUTEMAPPING";

DROP TABLE "PLMT"."PLM_MAPPING";

DROP TABLE "PLMT"."PLMATTRIBUTELIST";
